...
/********
 * input_buf - a function that allows buffers chained commands
...
ssize_t get_input(info_t *info)
{
	...
	if (len)
	{
		...
		*buf_p = p; /* passback pointer to current command position */
...
/*******
 * _getline - a function that will get the next line of input from STDIN
 * @info: a parameter struct.
 * @ptr: address of pointer to a buffer; preallocated or NULL
