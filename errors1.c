...
/*****
 * _erratoi - a function that converts the string to an integer.
 ...
 * @input: the input.
 * @fd: a filedescriptor to write too
...
/****
 * convert_number - the function that converter function, a clone of itoa
 * @num: a number
 * @base: a base
